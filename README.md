# AirBnB Clone ― The ALX-AirBnB_Project

## Description of the project
The ALX-AirBnB_Project sums up the implementation of our five months of studies at the ALX-FullStack_Software_Engineering_Program.The goal of the project is to deploy a replica of the Airbnb Website using my server. The final version of this project will have:
